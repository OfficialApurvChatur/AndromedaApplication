...
A proficient organization specializing in crafting sophisticated development and communication tools tailored for diverse web applications, under Beehive Corporation.

## Frontend Installation
- Open the terminal in any preferred location, create a folder name `AndromedaApplication`, and move inside with the following command.
```
mkdir AndromedaApplication
```
```
cd AndromedaApplication
```
...
```
git clone https://github.com/ApurvChatur/AndromedaApplication.git
```
...
- Kindly, check the documentation properly and ensure you are setting up the backend for `AndromedaApplication`.

## Administration Installation
- Please ensure you have set up the backend for `AndromedaApplication`, before setting up the admin.
...
- Kindly, check the documentation properly and ensure you are setting up the administration for `AndromedaApplication`.