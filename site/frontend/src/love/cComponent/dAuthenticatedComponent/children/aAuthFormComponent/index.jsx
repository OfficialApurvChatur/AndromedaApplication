        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto mb-4">
            <Alert variant="custom" >
              ...
              <AlertDescription>
                <p><b>Email:</b> shraddha.kapoor@andromeda.com</p> 
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            {ReduxUltimate.state.RequiredObject?.Loading ? (
              ...
              <div className="flex flex-wrap -m-2">
                    ...
                    <React.Fragment key={index} >
                      <div className="p-2 w-full">
                        <div className="relative">
                          ...
                          <input 
                            className="
                              w-full bg-[#FFDFB9] dark:bg-[#A4193D] bg-opacity-40 rounded border 
                ...
                <div className="p-2 w-full pt-2 mt-4 border-t border-[#A4193D] dark:border-[#FFDFB9] text-center">
