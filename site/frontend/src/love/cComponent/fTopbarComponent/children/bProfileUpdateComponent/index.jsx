          ...
          <div className="lg:w-4/6 mx-auto">
            ...
            <div className="flex flex-col sm:flex-row mt-10">
              <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                <div className="w-20 h-20 rounded-full inline-flex items-center justify-center bg-[#A4193D] dark:bg-[#FFDFB9] text-[#FFDFB9] dark:text-[#A4193D]">
                ...
                <div className="flex flex-col items-center text-center justify-center">
                  ...
                  <div className="w-12 h-1 bg-[#A4193D] dark:bg-[#FFDFB9] rounded mt-2 mb-4"></div>
                  <p className="text-base">{Redux.state.ReceivedObject?.Retrieve?.subtitle}</p>
                </div>
              </div>
              <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-[#A4193D] dark:border-[#FFDFB9] sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
        ...
        <div className="container px-5 py-12 mx-auto">
          <div className="flex flex-wrap -m-4">
            ...
            <div className="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border border-[#A4193D] dark:border-[#FFDFB9] flex flex-col relative overflow-hidden">
                <h1 className="text-2xl pb-4 mb-4 border-b border-[#A4193D] dark:border-[#FFDFB9] leading-none">Critical Information</h1>
                    ...
                    <div className='mb-2 mt-1 flex flex-1 space-x-4 items-center'>
                      <p>
                        <Avatar>
                          ...
                          <AvatarFallback className="bg-[#A4193D] dark:bg-[#FFDFB9] text-[#FFDFB9] dark:text-[#A4193D]">
                ...
                <div className="w-full mb-2">
                  <div className="relative">
                    ...
                    <input 
                      className="w-full bg-[#FFDFB9] dark:bg-[#A4193D] bg-opacity-40 rounded border 
                        border-[#A4193D] dark:border-[#FFDFB9]
                        focus:border-[#FFDFB9] dark:focus:border-[#A4193D] 
                        focus:bg-[#A4193D] dark:focus:bg-[#FFDFB9] 
                        focus:text-[#FFDFB9] dark:focus:text-[#A4193D] 
                        focus:ring-2 
                        focus:ring-[#A4193D] dark:focus:ring-[#FFDFB9] 
                        text-[#A4193D] dark:text-[#FFDFB9] 
            ...
            <div className="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border border-[#A4193D] dark:border-[#FFDFB9] flex flex-col relative overflow-hidden">
                <h1 className="text-2xl pb-4 mb-4 border-b border-[#A4193D] dark:border-[#FFDFB9] leading-none">Basic Information</h1>
            ...
            <div className="p-4 xl:w-1/3 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border border-[#A4193D] dark:border-[#FFDFB9] flex flex-col relative overflow-hidden">
                <h1 className="text-2xl pb-4 mb-4 border-b border-[#A4193D] dark:border-[#FFDFB9] leading-none">More Information</h1>

                <div className="w-full mb-2">
                  <div className="relative">
                    <label className="leading-7 text-sm">Address</label>
                    <input 
                      className="mb-2 w-full bg-[#FFDFB9] dark:bg-[#A4193D] bg-opacity-40 rounded border 
                        border-[#A4193D] dark:border-[#FFDFB9]
                        focus:border-[#FFDFB9] dark:focus:border-[#A4193D] 
                        focus:bg-[#A4193D] dark:focus:bg-[#FFDFB9] 
                        focus:text-[#FFDFB9] dark:focus:text-[#A4193D] 
