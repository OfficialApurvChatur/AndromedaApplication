...
function HeaderComponent({ Redux, LogoutAPICall }) {
  return (
    ...
    <React.Fragment>
      <header className="sticky top-0 z-50 w-full backdrop-blur supports-[backdrop-filter]:bg-[#FFDFB9]/60 dark:supports-[backdrop-filter]:bg-[#A4193D]/60 text-[#A4193D] dark:text-[#FFDFB9]">
