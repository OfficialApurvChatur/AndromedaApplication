              ...
              return (
                <React.Fragment key={index}>
                  <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                    <div className="bg-[#A4193D] dark:bg-[#FFDFB9] text-[#FFDFB9] dark:text-[#A4193D] bg-opacity-60 px-4 py-6 rounded-lg">
                      {
                        each.title === "Frontend Application Deployed" ? (
                          <div className="w-12 h-12 mb-3 inline-flex items-center justify-center rounded-full bg-[#FFDFB9] dark:bg-[#A4193D] text-[#A4193D] dark:text-[#FFDFB9] flex-shrink-0">
